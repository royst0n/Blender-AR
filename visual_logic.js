...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        bindListener, getSceneAnimFrameRate, getSceneByAction, AudioWebAudio,
        getObjectName, initObjectPicking, isObjectAmongObjects, transformCoordsSpace,
        getSceneCoordSystem, transformEulerV3dToBlenderShortest, RotationInterface, xrOnSelect,
        unbindListener, LIST_NONE, getEventOffsetCoords, isChangedTouchOrNotTouchEventAtAll,
        getEventFirstTouchId, createDragOverInfo,
    };
};
...
createCSSRule('.warning-center', "position: absolute; width: 100%; height: 50px; top: 50%; margin-top: -25px; left: 0px; display: none;", false, '');
...
createCSSRule('.warning-could-not-enter-AR', "position: absolute; width: 181px; height: 50px; left: 50%; margin-left: -90px; z-index: 1px; display: none;", false, '');
...
addHTMLElement('img', 'warning_could_not_enter_AR_img', 'TO', 'warning_could_not_enter_AR', false);
setHTMLElemAttribute('src', 'media/warning_could_not_enter_AR.png', 'warning_could_not_enter_AR_img', false);

createCSSRule('.info-button', "position: absolute; width: 50px; height: 50px; z-index: 1; top: 10px; right: 10px; background-repeat: no-repeat; display: block; color: #000000; overflow: hidden; border-style: none; border-color: #000000; cursor: pointer;", false, '');
addHTMLElement('a', 'info_button', 'TO', ['CONTAINER'], false);
setHTMLElemAttribute('className', 'info-button', 'info_button', false);
setHTMLElemAttribute('href', 'https://royston.com', 'info_button', false);
setHTMLElemAttribute('target', '_blank', 'info_button', false);
...
changeVis(['prompt_move_around', 'ready_button', 'edit_button', 'drag_move', 'drag_rotate', 'drag_scale', 'scale_percentage'], false);

operateAnimation('PLAY', 'roy_armature', 0, 180, 'LoopRepeat', 1,
        function() {}, false);


volume(loadMedia_WebAudio('sounds/hello.mp3'), 0.5);
registerOnClick('Roy_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'roy_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'roy_armature', 181, 275, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'roy_group'], false);
      ...
      changeVis(['GROUP', 'roy_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('roy_armature', false, 'position', createVector(0, 0, 0), false);
      changeVis(['drag_move', 'drag_rotate', 'drag_scale', 'ready_button', 'edit_button', 'scale_percentage'], false);
      setObjTransform('roy_armature', false, 'scale', [1, 1, 1], false);
      updateTextObj('scale_percentage', '100%');
      show_warning('warning_could_not_enter_AR');
    }, function() {});
  });
}, function() {
  setHTMLElemAttribute('href', exportToUSDZ('Roy_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'roy.usdz', 'enter_AR_button', false);
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'roy_group'], true);
  setObjTransform('roy_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('roy_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
  changeVis(['scale_percentage', 'ready_button', 'edit_button', 'drag_move', 'drag_rotate', 'drag_scale'], false);
  changeVis(['GROUP', 'indicator_group'], false);
}, function() {});
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('roy_armature', 'XY', 'WORLD', 'H:R2}zz3Lj[]J`@KcaLj', '2~K|K6}BaLGBw3,{%?,o');
}, function() {}, '2~K|K6}BaLGBw3,{%?,o');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('roy_armature', 'Z', 'WORLD', 'paYQeQSN58|Nb-]9$w_I', 'Z%[;=X8K}*-Te-O6Ll]7');
}, function() {}, 'Z%[;=X8K}*-Te-O6Ll]7');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('roy_armature', 'Z', 'b$bb+Q/$VPpd-?M:$K`l', 've[VL9eWZUUJaJ*(l0Io');
  dragScale('roy_armature', 'X', '#?z%U%j{d0f;1mxnPuoJ', 've[VL9eWZUUJaJ*(l0Io');
  dragScale('roy_armature', 'Y', '0B7bsp~KsFubU%oa9~Zf', 've[VL9eWZUUJaJ*(l0Io');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('roy_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 've[VL9eWZUUJaJ*(l0Io');
